...
class MainViewModel: ObservableObject {
    ...
    @Published var facilityIcons: [String: String] = [:] // wifi: wifi the string with icon
    @Published var isLoading = false
    @Published var currentMonthName: String = ""
    @Published var calendarDays: [(dayName: String, dateNumber: String)] = []
    @Published var errorMessage: String? = nil

    private let boardroomsURL = "https://api.airtable.com/v0/appElKqRPusTLsnNe/boardrooms"//get
    private let facilitiesURL = "https://api.airtable.com/v0/appElKqRPusTLsnNe/facilities"
